...
export default function NewQuestPage() {
  ...
  const [form, setForm] = useState({
    poiId: "", title: "", description: "", order: 1, xpReward: 50, yenReward: 100, isActive: true,
  });
    ...
    <div className="p-8 max-w-xl">
      ...
      <div className="bg-white rounded-xl border border-gray-200 p-6 space-y-4">
        ...
        <div className="grid grid-cols-3 gap-4">
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">Yens</label>
            <input type="number" className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm"
              value={form.yenReward} onChange={(e) => setForm({ ...form, yenReward: parseInt(e.target.value) })} />
          </div>
        </div>
